...
import type {
  ...
  import { deleteCategory, getCategory } from "@/actions/otherActions";
    ...
    const columns: ColumnsType<DataType> = [
      ...
      },
      {
      ...
      },
        {
          ...
          render: (details, record) => (
            <Space size="middle">
                <Button type="primary" onClick={handleOpenModal}>Edit</Button>
                <Modal
                ...
                >
                  <Form onFinish={onFinish}>
                    <Form.Item
                      ...
                      name="categorytitle"
                      rules={[{ required: true, message: 'Please input your category title!' }]}
                    >
                      <Input type="text"/>
                    </Form.Item>
                    <Form.Item>
