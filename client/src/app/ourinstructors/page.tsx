...
const OurInstructors = () => {
  return (
    <>
      ...
      <Navbar />
      <Pagetitle page="Our Instructors"/>
      <div className="our-instructors-area ptb-100">
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-xl-3 col-sm-6">
              <div className="single-instructors-item">
                ...
                <div className="instructors-content">
                  <h3>
                    <a href="instructors-details.html">Ethan Michael</a>
                  </h3>
                  <span>Development Teacher</span>
                  <ul className="review">
                    <li>
            ...
            <div className="col-xl-3 col-sm-6">
              <div className="single-instructors-item">
                <a href="instructors-details.html">
                  <img
                    src="assets/images/instructors/instructors-6.jpg"
                    alt="Image"
                  />
                </a>
                <div className="instructors-content">
                  <h3>
                    <a href="instructors-details.html">Emma Olivia</a>
                  </h3>
                  <span>PHP Teacher</span>
                  <ul className="review">
                    <li>
                      <i className="ri-star-s-fill" />
                    </li>
            ...
            <div className="col-xl-3 col-sm-6">
              <div className="single-instructors-item">
                <a href="instructors-details.html">
                  <img
                    src="assets/images/instructors/instructors-7.jpg"
                    alt="Image"
                  />
                </a>
                <div className="instructors-content">
                  <h3>
                    <a href="instructors-details.html">Abigail Emily</a>
                  </h3>
                  <span>Banking Teacher</span>
                  <ul className="review">
                    <li>
            ...
            <div className="col-xl-3 col-sm-6">
              <div className="single-instructors-item">
                <a href="instructors-details.html">
                  <img
                    src="assets/images/instructors/instructors-8.jpg"
                    alt="Image"
                  />
                </a>
                <div className="instructors-content">
                  <h3>
                    <a href="instructors-details.html">Jayden Daniel</a>
                  </h3>
                  <span>UX / UI Teacher</span>
                  <ul className="review">
                    <li>
